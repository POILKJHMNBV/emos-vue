        ...
        <el-form :inline="true" :model="dataForm" :rules="dataRule" ref="dataForm">
            ...
            <el-form-item>
                ...
                <el-button
                        type="danger"
                        size="medium"
                        :disabled="!isAuth(['ROOT', 'LEAVE:INSERT'])"
                        @click="addHandle()"
                >
                    我要请假
                </el-button>
            ...
            <el-table-column header-align="center" align="center" width="120" label="请假单" min-width="120">
                <template #default="scope">
                    <el-button
                            type="text"
                            size="medium"
                            v-if="scope.row.status === '已同意' && isAuth(['ROOT', 'LEAVE:SELECT'])"
            ...
            <el-table-column header-align="center" align="center" width="150" label="操作" min-width="120">
                <template #default="scope">
                    <el-button
                            type="text"
                            size="medium"
                            v-if="isAuth(['ROOT', 'LEAVE:DELETE'])"
                            :disabled="scope.row.status === '已同意' || !scope.row.mine"
    ...
    methods: {
        ...
        deleteHandle: function (id) {
            ...
            that.$confirm(`确定要删除选中的记录？`, '提示', {
                ...
                that.$get('leave/deleteLeaveById', {"leaveId": id}, true, function (resp) {
                    if (resp.rows > 0) {
                        that.$message({
                            message: '操作成功',
                            type: 'success',
