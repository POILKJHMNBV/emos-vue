        ...
        <nav class="site-navbar" :class="'site-navbar--' + navbarLayoutType">
            ...
            <div class="site-navbar__body clearfix">
                ...
                <el-menu class="site-navbar__menu site-navbar__menu--right" mode="horizontal">
                     <el-menu-item v-if="approvalTaskCount !== 0" index="1" class="site-navbar__switch">
                        <template #title>
                            <el-badge :value="approvalTaskCount"><SvgIcon name="duanxin" class="icon-svg duanxin-svg" /></el-badge>
                        </template>
                    </el-menu-item>
        ...
        <aside class="site-sidebar site-sidebar--dark">
            <div class="site-sidebar__inner">
                ...
                >
                    ...
                    <el-submenu index="组织管理"
                                :popper-class="'site-sidebar--' + sidebarLayoutSkin + '-popper'"
                                v-if="isAuth(['ROOT', 'DEPT', 'ROLE', 'USER'])">
                        <template #title>
                    ...
                    <el-submenu index="会议管理" :popper-class="'site-sidebar--' + sidebarLayoutSkin + '-popper'">
                        ...
                        <el-menu-item
                                index="meeting-room"
                                v-if="isAuth(['ROOT', 'MEETING_ROOM:SELECT'])"
...
export default {
    ...
    mounted: function () {
        ...
        that.$http('user/searchApprovalTaskCountWithMe', 'GET', null, true, function (resp) {
            that.approvalTaskCount = resp.approvalTaskCount;
        });
