<template>
    <div v-if="isAuth(['ROOT', 'USER:SELECT'])">
        ...
        <dimiss v-if="dimissVisible" ref="dismiss" @refreshDataList="loadDataList"></dimiss>
    </div>
</template>
...
export default {
    ...
    methods: {
        ...
        dimissHandle: function (id) {
            this.dimissVisible = true;
            this.$nextTick(() => {
                this.$refs.dismiss.init(id);
            })
        },
